        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedPetId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoodWith = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Areas",
                columns: new[] { "AreaId", "AreaName", "City", "IsActive", "Pincode" },
                values: new object[,]
                {
                    { 1, "Satellite", "Ahmedabad", true, "380015" },
                    { 2, "Vastrapur", "Ahmedabad", true, "380054" },
                    { 3, "Bodakdev", "Ahmedabad", true, "380054" },
                    { 4, "Prahlad Nagar", "Ahmedabad", true, "380015" },
                    { 5, "SG Highway", "Ahmedabad", true, "380054" },
                    { 6, "Navrangpura", "Ahmedabad", true, "380009" },
                    { 7, "Paldi", "Ahmedabad", true, "380007" },
                    { 8, "Maninagar", "Ahmedabad", true, "380008" },
                    { 9, "Chandkheda", "Ahmedabad", true, "382424" },
                    { 10, "Gota", "Ahmedabad", true, "382481" },
                    { 11, "Bopal", "Ahmedabad", true, "380058" },
                    { 12, "Thaltej", "Ahmedabad", true, "380054" },
                    { 13, "South Bopal", "Ahmedabad", true, "380058" },
                    { 14, "Shilaj", "Ahmedabad", true, "382427" },
                    { 15, "Ambawadi", "Ahmedabad", true, "380015" }
                });
